...
from neutron.db import vpn_attrs_db
from neutron.db import vpn_db
from neutron.extensions import portbindings
from neutron import manager
from neutron.plugins.common import constants as service_constants

from neutron_vpnaas.db.vpn.vpn_agentschedulers_db import vpn_sch_db

class VPN_HA_scheduler_db_mixin(vpn_sch_db.AZL3AgentSchedulerDbMixin):
    ...
    def get_vpn_agents_ordered_by_num_routers(self, context, agent_ids):
        ...
        query = (context.session.query(agents_db.Agent, func.count(
            vpn_sch_db.RouterL3AgentBinding.router_id).label('count')).
            outerjoin(vpn_sch_db.RouterL3AgentBinding).
